...
public class BigGA extends FitnessFunction {
	...
	public static final int CHROMOSOME_AMOUNT = 22; 
	...
	public void run() throws Exception{
		...
		sampleGenes[0] = new IntegerGene(conf,0,1); // direction of movement
		sampleGenes[1] = new DoubleGene(conf,100,200); // distance
		sampleGenes[2] = new DoubleGene(conf,100,350); // safe distance from the wall
		
		sampleGenes[5] = new DoubleGene(conf,0,100); // Energy threshold 
		sampleGenes[6] = new DoubleGene(conf,10,40); // max Stationary time
		
		sampleGenes[7] = new DoubleGene(conf,100,250); // set back after hitting the wall
		sampleGenes[8] = new DoubleGene(conf,10,90); // Angle
